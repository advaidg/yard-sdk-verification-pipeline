"""Auto-generated Chain Executor for SDK Verification Pipeline."""
import asyncio
import json
import os
import time
...
app = FastAPI(title="SDK Verification Pipeline")
...
AGENTS = [
    {"id": "node-0661e459", "agent_id": "fa08fb4c-86ab-4856-960f-f751b55e551f", "name": "triage-classifier", "endpoint": "http://triage-classifier:9101", "timeout": 30},
    {"id": "node-00a4838e", "agent_id": "b6f354f8-0746-4df8-a91e-da44df696f6d", "name": "triage-sentiment", "endpoint": "http://triage-sentiment:9102", "timeout": 30},
]
...
EDGES = [
    {"id": "", "source": "node-0661e459", "target": "node-00a4838e", "transform": "passthrough"},
]


async def call_agent(endpoint: str, input_data: dict) -> dict:
    async with httpx.AsyncClient() as client:
        resp = await client.post(endpoint, json={"input": input_data}, headers=AGENT_HEADERS, timeout=300)
